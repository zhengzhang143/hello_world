...
%SEDLOCALPATH%\sed -r "s#sourcebranch#%PRJSRCGITBRANCH%#" "%QACLOCALPATH%\batch\config.bat" | %SEDLOCALPATH%\sed -r "s#origin#%PRJSRCGIT%#" > "%QACLOCALPATH%\batch\GenQACPrj.bat"
